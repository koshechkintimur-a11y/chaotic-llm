...
## Ночной прогон (Stack, 100M токенов)

| Метрика | STS-Prog 1.4M | Transformer 1.45M |
|---|---|---|
| Mixer PPL | **25.65** | 38.22 |
| Retrieval L=16 | **67%** | 0% |
| Retrieval L=256 | **60%** | 40% |

Масштабирование данных подтверждает прорыв: на большом корпусе разрыв даже больше.
